/* ============================================================
   Datara 原型 · 模拟数据（内存态，刷新重置）
   状态机字典 + 种子数据（对齐 P0 清单 12 模块 121 项功能）
   ============================================================ */
var now = '2026-09-12';
var yesterday = '2026-09-11';
...
function st(key){var s=ST[key]||{label:key,cls:'st-gray'};return '<span class="st '+s.cls+'"><i class="dot"></i>'+s.label+'</span>';}
function tag(text,type,lg){return '<span class="tag tag-'+(type||'gray')+(lg?' tag-lg':'')+'">'+text+'</span>';}
...
var DB = {
  ...
  notifications: [
    ...
    {id:4, icon:'⇩', cls:'info', title:'指标变更审批待处理', desc:'「近7天支付金额」口径变更申请待评审', time:'2026-09-11 18:40'}
  ],
  ...
  syncBatches: [
    {id:'SYNC_20260911_001', srcDs:'DS003', srcName:'MySQL-业务测试库', target:'Doris-分析集群', mode:'首次全量+后续增量', strategy:'自动建表+按天分区',
     ...
     logs:[
       {st:'user_info', tt:'ods_mysql_user_info', sc:1250000, tc:1250000, dc:0, status:'success', dur:'45s'},
       {st:'order_info', tt:'ods_mysql_order_info', sc:5000000, tc:5000000, dc:0, status:'success', dur:'120s'},
       {st:'product_info', tt:'ods_mysql_product_info', sc:80000, tc:78000, dc:2000, status:'diff', dur:'15s'},
       {st:'user_address', tt:'ods_mysql_user_address', sc:0, tc:0, dc:0, status:'failed', dur:'8s'},
       {st:'pay_log', tt:'ods_mysql_pay_log', sc:3200000, tc:3200000, dc:0, status:'success', dur:'95s'},
       {st:'member_level', tt:'ods_mysql_member_level', sc:120000, tc:120000, dc:0, status:'success', dur:'22s'},
       {st:'coupon_record', tt:'ods_mysql_coupon_record', sc:890000, tc:890000, dc:0, status:'success', dur:'60s'}
     ]},
  ...
  /* ===== M09 元数据 ===== */
  collectTasks: [
    {id:'MC001', name:'Doris全仓技术元数据采集', scope:'Doris-分析集群：dw_olap全部库表', type:'定时', cron:'0 0 1 * * ?', lastRun:'2026-09-12 01:00', lastResult:'success', tables:186, status:'enabled'},
    {id:'MC002', name:'万里生产库采集', scope:'万里GreatDB-生产业务库：gdb_biz', type:'定时', cron:'0 30 1 * * ?', lastRun:'2026-09-12 01:30', lastResult:'success', tables:96, status:'enabled'},
    {id:'MC003', name:'调度任务操作元数据采集', scope:'DAG调度系统：任务/依赖/产出表', type:'触发式', cron:'-', lastRun:'2026-09-12 07:35', lastResult:'success', tables:0, status:'enabled'},
    {id:'MC004', name:'达梦经营库采集', scope:'达梦DM8-经营管理库', type:'定时', cron:'0 0 2 * * ?', lastRun:'2026-09-12 02:00', lastResult:'running', tables:24, status:'enabled'}
  ],
  bizDomains: [
  ...
  metaTables: [
    {id:'T1', name:'ods_gdb_biz_user_info', layer:'ODS', domain:'公共', rows:1250000, size:'320MB', owner:'王工', tags:['核心'], yesterdayOk:true, desc:'万里生产用户信息原样同步', sample:[{user_id:100001,user_name:'张伟',gender:'M',phone:'138****1234',create_time:'2026-01-03 10:21:00'},{user_id:100002,user_name:'王芳',gender:'F',phone:'139****5678',create_time:'2026-01-03 11:45:00'},{user_id:100003,user_name:'李娜',gender:'F',phone:'137****9012',create_time:'2026-01-04 08:30:00'}]},
    {id:'T2', name:'ods_gdb_biz_trade_order', layer:'ODS', domain:'交易域', rows:4100000, size:'1.2GB', owner:'王工', tags:['核心'], yesterdayOk:true, desc:'万里生产交易订单原样同步', sample:[{order_id:90001,user_id:100001,amount:299.00,status:'1',create_time:'2026-09-11 09:00:12'},{order_id:90002,user_id:100002,amount:1299.00,status:'1',create_time:'2026-09-11 09:12:40'}]},
    {id:'T3', name:'dwd_order_pay_detail', layer:'DWD', domain:'交易域', rows:3980000, size:'860MB', owner:'李工', tags:['核心','已映射'], yesterdayOk:true, desc:'清洗后的支付明细事实表', sample:[{pay_id:20260911000001,order_id:90001,user_id:100001,pay_amount:299.00,pay_status:1,channel:'ALIPAY',dt:'2026-09-11'},{pay_id:20260911000002,order_id:90002,user_id:100002,pay_amount:1299.00,pay_status:1,channel:'WECHAT',dt:'2026-09-11'}]},
    {id:'T4', name:'dws_pay_summary_daily', layer:'DWS', domain:'交易域', rows:1860, size:'2MB', owner:'李工', tags:['核心'], yesterdayOk:true, desc:'支付主题日汇总', sample:[{stat_date:'2026-09-11',channel:'ALIPAY',pay_user_cnt:3210,pay_order_cnt:4102,pay_amount_sum:528210.55},{stat_date:'2026-09-11',channel:'WECHAT',pay_user_cnt:2890,pay_order_cnt:3640,pay_amount_sum:451870.20}]},
    {id:'T5', name:'ads_kpi_report', layer:'ADS', domain:'经营域', rows:365, size:'1MB', owner:'赵工', tags:['报表'], yesterdayOk:true, desc:'经营KPI报表宽表', sample:[{stat_date:'2026-09-11',gmv:980080.75,pay_user_cnt:5660,pay_amount_7d:6520000.00}]},
    {id:'T6', name:'dim_user', layer:'DIM', domain:'公共', rows:1250000, size:'210MB', owner:'王工', tags:['核心','已映射'], yesterdayOk:true, desc:'用户公共维度表', sample:[{user_id:100001,user_name:'张伟',org_name:'大发局',user_level:'02'}]},
    {id:'T7', name:'ods_oracle_gl_voucher', layer:'ODS', domain:'财务域', rows:560000, size:'420MB', owner:'赵工', tags:['涉密'], yesterdayOk:true, desc:'ERP总账凭证原样同步', sample:[{voucher_id:'V20260911001',subject:'1001库存现金',debit:12000.00,credit:0,dt:'2026-09-11'}]},
    {id:'T8', name:'ods_mysql_product_info', layer:'ODS', domain:'商品域', rows:78000, size:'95MB', owner:'张工', tags:['差异待核'], yesterdayOk:false, desc:'MySQL商品信息同步（存在2000行差异）', sample:[{product_id:1,product_name:'数据治理服务包年',price:98000.00,dt:'2026-09-11'}]}
  ],
  tableLineage: [
  ...
  indicators: [
    ...
    {id:'METRIC_006', name:'支付转化率', en:'pay_conv_rate', type:'计算', bizDef:'支付用户数 / 访问用户数', techDef:'pay_user_cnt / visit_user_cnt',
     srcTable:'dws_pay_summary_daily', srcField:'pay_user_cnt', outTable:'-', outTask:'-', period:'日', dims:'-', owner:'李工', domain:'交易域', status:'review', v:2, formula:'支付用户数 / 访问用户数 × 100%',
     trend:[0.62,0.63,0.61,0.64,0.65,0.64,0.66,0.67], unit:'%', changeNote:'访问口径从PV调整为UV',
     versions:[{v:2,date:'2026-09-11',note:'访问口径PV→UV（评审中）',author:'李工'},{v:1,date:'2026-08-28',note:'初版',author:'李工'}]}
  ],
  indApprovals: [
    {id:'IA20260911-01', metric:'METRIC_006 支付转化率（v1→v2）', proposer:'李工', reason:'访问口径从PV调整为UV，与运营侧对齐', submitAt:'2026-09-11 15:30', flow:['发起','评审','发布'], current:1, status:'review'},
    {id:'IA20260908-02', metric:'METRIC_001 支付金额（v1→v2）', proposer:'李工', reason:'明确不含退款', submitAt:'2026-09-08 10:00', flow:['发起','评审','发布'], current:3, status:'published'},
    {id:'IA20260910-01', metric:'METRIC_002 近7天支付金额', proposer:'赵工', reason:'试调整剔除退款单', submitAt:'2026-09-10 14:00', flow:['发起','评审','发布'], current:1, status:'reject', opinion:'剔除退款影响同比可比性，驳回；保持原口径'}
  ],
  indConsistency: [
  ...
  wfInstances: [
    {id:'R20260912-001', wf:'WF001', wfName:'订单主题日增', bizDate:'2026-09-11', status:'failed', startAt:'2026-09-12 02:30', endAt:'-', dur:'-',
     nodes:[
    ...
    {id:'R20260912-002', wf:'WF002', wfName:'维度日更', bizDate:'2026-09-11', status:'success', startAt:'2026-09-12 02:00', endAt:'2026-09-12 02:03', dur:'3m',
     nodes:[
    ...
    {id:'R20260912-003', wf:'WF003', wfName:'经营KPI', bizDate:'2026-09-11', status:'success', startAt:'2026-09-12 04:00', endAt:'2026-09-12 04:04', dur:'4m',
     nodes:[
    ...
    {id:'R20260911-001', wf:'WF001', wfName:'订单主题日增', bizDate:'2026-09-10', status:'success', startAt:'2026-09-11 02:30', endAt:'2026-09-11 02:41', dur:'11m',
     nodes:[
       {id:'n1', name:'同步订单表', status:'success', start:'02:30:05', end:'02:32:35', dur:'150s', retry:0},
       {id:'n2', name:'清洗支付明细', status:'success', start:'02:32:36', end:'02:34:11', dur:'95s', retry:0},
